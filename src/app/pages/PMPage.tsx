    ...
    <>
      ...
      <section className="detail-hero">
        ...
        <div className="detail-hero-inner">
          ...
          <div className="eyebrow">Project Management for Beginners</div>
          <h1>Manage projects with<br /><em>clarity, not chaos.</em></h1>
          <p className="detail-hero-sub">Know the frameworks, do the planning, become the person teams rely on, have the career that reflects it. No jargon. No confusion.</p>
        </div>
      </section>

      <div className="coming-detail">
        <div className="coming-detail-icon">📋</div>
        <h2>This course is coming soon.</h2>
        <p>We are building something great. Drop your email below and be the first to know when Project Management for Beginners launches — including early bird pricing.</p>
